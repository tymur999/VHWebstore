...
using VHacksWebstoreML.Model;

namespace VHacksWebstoreML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\Tymur\Downloads\toxic_sentiment.csv";
        ...
        private static void SaveModel(MLContext mlContext, ITransformer mlModel, string modelRelativePath, DataViewSchema modelInputSchema)
        {
            ...
            mlContext.Model.Save(mlModel, modelInputSchema, Path.GetFullPath(modelRelativePath));
