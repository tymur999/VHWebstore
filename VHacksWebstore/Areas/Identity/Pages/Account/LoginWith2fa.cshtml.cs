...
namespace VHacksWebstore.Areas.Identity.Pages.Account
{
    ...
    public class LoginWith2faModel : PageModel
    {
        ...
        public LoginWith2faModel(SignInManager<WebstoreUser> signInManager, ILogger<LoginWith2faModel> logger, UserManager<WebstoreUser> userManager, IEmailSender emailSender)
        {
